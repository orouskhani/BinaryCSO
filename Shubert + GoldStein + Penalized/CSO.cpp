...
int main(int argc, char* argv[])
{
	...
	int i_Dim[i_FuncNum]={5 , 2 , 2};			// Defines the dimension of the benchmark functions.
  ...
  double d_InitL[i_FuncNum]={-10 , -2 , -50};       // Defines the left border of the initial ranges.
  double d_InitR[i_FuncNum]={10 , 2 , 50};       // Defines the right border of the initial ranges.
  double d_MaxVel[i_FuncNum]={10 , 2 , 50};     // Defines the maximum velocity of the cats.
