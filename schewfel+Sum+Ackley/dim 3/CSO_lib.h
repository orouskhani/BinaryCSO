...
#define SRD		  0.2     // The percentage of the perturbation on the selected dimensions in the "Tracing" mode.
#define CDC			0.5     // Mutation Range form this point to the other.
#define CBC			0.2
...
#define MR			0.05	  // The ratio of cats in the "Seeking" mode.
